...
# use conda
# RUN wget https://mirrors.tuna.tsinghua.edu.cn/anaconda/miniconda/Miniconda3-py37_4.9.2-Linux-aarch64.sh 
# RUN zsh Miniconda3-py37_4.9.2-Linux-aarch64 -b
...
# # install cmake
RUN wget https://download.fastgit.org/Kitware/CMake/releases/download/v3.20.3/cmake-3.20.3-linux-aarch64.tar.gz
RUN tar -zxvf cmake-3.20.3-linux-aarch64.tar.gz
ENV PATH /root/cmake-3.20.3-linux-aarch64/bin:$PATH
RUN echo 'PATH="/root/cmake-3.20.3-linux-aarch64/bin:$PATH"' >> /root/.zshrc
